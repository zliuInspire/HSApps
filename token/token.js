...
contract SafeMath {
    ...
    function dateBonus(uint startIco) view internal returns (uint256) {
...
contract ShiftCashToken is StandardToken, SafeMath {
    ...
    function ShiftCashToken(address _icoContract) public {
    ...
    function burnTokens(address _from, uint _value) public onlyIcoContract {
        assert(_from != 0x0);
        require(_value > 0);
    ...
    function emitTokens(address _to, uint _value) public onlyIcoContract {
        assert(_to != 0x0);
        require(_value > 0);
...
contract ShiftCashIco is SafeMath {
    ...
    function ShiftCashIco(address _icoManager, address _preIcoToken) public {
    ...
    function init(address _founder1, address _escrow) onlyManager public {
    ...
    function setNewManager(address _newIcoManager) public onlyManager {
    ...
    function setBountyOwner(address _bountyOwner) public onlyManager {
    ...
    function importTokens(address _account) public {
    ...
    function sendTokensToBountyOwner() public onlyManager whenInitialized {
